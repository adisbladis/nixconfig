{ pkgs, lib, config, ... }:
{
  ...
  services.nginx = {
    ...
    virtualHosts."blad.is" = {
      enableACME = true;
      forceSSL = true;
      locations = {
        "/.well-known/matrix/server".extraConfig =
          let
            server."m.server" = "matrix.blad.is:443";
          in
          ''
        ...
        "/.well-known/matrix/client".extraConfig =
          let
            client."m.homeserver".base_url = "https://matrix.blad.is";
          in
          ''
            add_header Content-Type application/json;
          ...
          '';
        "/_matrix/".return = "307 http://matrix.blad.is$request_uri";
      };
    };

    virtualHosts."element.blad.is" = {
      enableACME = true;
      forceSSL = true;
      locations."/" = {
